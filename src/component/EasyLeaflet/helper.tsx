...
//     };
//   },
//   // addSpecialLayer: function(url: string, i: number) {
//   // let options = {
...
//   //   },
//   // };
//   // let lay = (L.TileLayer as any).webdogTileLayer(url, options);
//   // lay.addTo(map:any);
//   // },
//   // eslint-disable-next-line
//   init_4326: () => {
//     (L.TileLayer as any).WMTS = L.TileLayer.extend({
//       defaultWmtsParams: {
//         service: 'WMTS',
//         request: 'GetTile',
//         version: '1.0.0',
