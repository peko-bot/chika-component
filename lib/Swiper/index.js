...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/component/Swiper/index.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js!./src/component/Swiper/css/Swiper.css":
/*!*****************************************************************************************************!*\
  !*** ./node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js!./src/component/Swiper/css/Swiper.css ***!
  \*****************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/component/Swiper/css/Swiper.css":
/*!*********************************************!*\
  !*** ./src/component/Swiper/css/Swiper.css ***!
  \*********************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js!./Swiper.css */ "./node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js!./src/component/Swiper/css/Swiper.css");
...
/***/ "./src/component/Swiper/index.jsx":
/*!****************************************!*\
  !*** ./src/component/Swiper/index.jsx ***!
  \****************************************/
...
/* harmony import */ var _css_Swiper_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./css/Swiper.css */ "./src/component/Swiper/css/Swiper.css");
...
var loading = './assets/loading.gif';
var complete = './assets/complete.png';
...
function (_React$Component) {
  ...
  function Swiper() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Swiper).apply(this, arguments));
    _this.startY = 0;
    _this.endY = 0;
    _this.scrollerHeight = 10000;
    ...
    _this.componentDidMount = function () {
      _this.bindEvent(_this.wrapper);
    };

    _this.getChildHeight = function () {
      var wrapperHeight = _this.props.wrapperHeight;
      var scrollHeight = _this.scroller.scrollHeight;
      _this.bottomHeight = scrollHeight - wrapperHeight + 44;
      _this.scrollerHeight = scrollHeight;
    };

    _this.bindEvent = function (refs) {
      var _this$props$sensibili = _this.props.sensibility,
          sensibility = _this$props$sensibili === void 0 ? 1 : _this$props$sensibili;
      refs.addEventListener('touchstart', function (e) {
      ...
      refs.addEventListener('touchmove', function (e) {
        e.preventDefault(); // distance of wrapper moving

        var distance = (e.touches[0].pageY - _this.startY) / sensibility + _this.endY;
        var iconDeg;
      ...
      refs.addEventListener('touchend', function () {
        ...
        if (distance > 44) {
          ...
          var _this$scroller = _this.scroller,
              offsetHeight = _this$scroller.offsetHeight,
              scrollHeight = _this$scroller.scrollHeight;
          var differHeight = scrollHeight - offsetHeight; // 超出边界回弹
          // 这里不能写等于，不然容器拖到底部时，touchstart会触发加载事件

          if (Math.abs(distance) > differHeight) {
            _this.endY = -differHeight; // 下拉加载

            if (onLoad) {
              _this.setState({
                loadText: '加载中...',
                loadImg: loading,
                distance: -_this.bottomHeight,
                status: 'loading',
                type: 'load'
              });
    ...
    _this.generateStyle = function () {
      var _this$props2 = _this.props,
          wrapperHeight = _this$props2.wrapperHeight,
          _this$props2$duration = _this$props2.duration,
          duration = _this$props2$duration === void 0 ? 1 : _this$props2$duration;
      var _this$state = _this.state,
          distance = _this$state.distance,
          refreshEnd = _this$state.refreshEnd,
          loadEnd = _this$state.loadEnd;
      var clientHeight = document.documentElement.clientHeight || document.body.clientHeight;
      var refreshStyle = {};
      var loadStyle = {};
      var wrapperStyle = {};
      var transform = "translate3d(0px, ".concat(distance, "px, 0)");
      var transition = "all ".concat(duration, "s ease");
      refreshStyle.transform = transform;
      if (refreshEnd) refreshStyle.transition = transition;
      loadStyle.transform = transform; // loadStyle.top = this.scrollerHeight;

      if (loadEnd) loadStyle.transition = transition;
      wrapperStyle = _extends({}, refreshStyle, {
    ...
    _this.renderSpinner = function (_ref) {
      var _classNames;

      var type = _ref.type,
          isFinished = _ref.isFinished,
          relatedStyle = _ref.relatedStyle,
          iconUrl = _ref.iconUrl,
          iconDeg = _ref.iconDeg,
          relatedText = _ref.relatedText;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: classnames__WEBPACK_IMPORTED_MODULE_2___default()((_classNames = {}, _defineProperty(_classNames, type, true), _defineProperty(_classNames, "".concat(type, "-end"), isFinished), _classNames)),
        style: relatedStyle
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "".concat(type, "-icon"),
        style: {
          transform: "rotateZ(".concat(iconDeg, "deg)")
        }
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
        src: iconUrl
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "".concat(type, "-text")
      }, relatedText));
    };
  ...
  _createClass(Swiper, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.loading && !this.props.loading && prevState.status === 'loading') {
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          iconDeg = _this$state2.iconDeg,
          refreshEnd = _this$state2.refreshEnd,
          refreshText = _this$state2.refreshText,
          refreshImg = _this$state2.refreshImg,
          loadEnd = _this$state2.loadEnd,
          loadText = _this$state2.loadText,
          loadImg = _this$state2.loadImg;

      var _this$generateStyle = this.generateStyle(),
          refreshStyle = _this$generateStyle.refreshStyle,
          wrapperStyle = _this$generateStyle.wrapperStyle,
          loadStyle = _this$generateStyle.loadStyle;
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        ref: function ref(_ref2) {
          return _ref2 && (_this3.scroller = _ref2);
        }
      }, children), onRefresh && this.renderSpinner({
        type: 'refresh',
