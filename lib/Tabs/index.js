...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/component/Tabs/index.jsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js!./src/component/Tabs/css/Tabs.css":
/*!*************************************************************************************************!*\
  !*** ./node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js!./src/component/Tabs/css/Tabs.css ***!
  \*************************************************************************************************/
...
var content = __webpack_require__(/*! !../../../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js!./Tabs.css */ "./node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js!./src/component/Tabs/css/Tabs.css");
...
/* harmony import */ var _css_Tabs_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./css/Tabs.css */ "./src/component/Tabs/css/Tabs.css");
/* harmony import */ var _css_Tabs_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_css_Tabs_css__WEBPACK_IMPORTED_MODULE_1__);
  ...
  function Tabs(props) {
    ...
    */
    ...
    _this.resetUnderline = function () {
      setTimeout(function () {
        var currentSelect = _this.props.currentSelect; // 页签项下划线宽度

        var coefficient = [];

        for (var i = 0; i < _this.state.dataSource.length; i++) {
          var spanWidth = _this["panel_span_".concat(i)].offsetWidth;

          var itemWidth = _this["panel_item_".concat(i)].offsetWidth;

          var itemHeight = _this["panel_item_".concat(i)].offsetHeight;

          _this["panel_item_".concat(i)].addEventListener('transitionend', function () {
        ...
        _this.setState({
          underlineItem: coefficient[currentSelect]
        });
      }, 0);
    };
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          currentSelect = _this$props.currentSelect,
      ...
      var _this$state2 = this.state,
          ...
          underlineItem = _this$state2.underlineItem,
          rippleConfig = _this$state2.rippleConfig;
      var scale = rippleConfig.scale,
          ...
          displayFlag = rippleConfig.displayFlag; // 波纹

      var rippleStyle = _extends({}, {
        top: offsetTop,
        ...
        transition: 'transform .7s cubic-bezier(0.250, 0.460, 0.450, 0.940), opacity .7s cubic-bezier(0.250, 0.460, 0.450, 0.940)',
        borderRadius: '50%',
        opacity: opacity
      });

      var tabs = [];
      tabs.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        key: "container_ul",
        className: "container",
        style: containerStyle
      }, dataSource.map(function (item, i) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          key: "dataSource_".concat(i),
          className: "item",
          style: _extends({
          ...
          ref: function ref(_ref2) {
            return _this2["panel_item_".concat(i)] = _ref2;
          }
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          className: currentSelect == i ? 'active' : '',
          ref: function ref(_ref) {
            return _this2["panel_span_".concat(i)] = _ref;
          }
      ...
      underline.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        key: "underline",
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "Tabs"
      }, tabs, underline, react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.map(children, function (child, i) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: "child_".concat(i),
          className: "child-content",
          style: {
            transform: "translate3d(".concat((i - currentSelect) * 100, "%, 0, 0)")
          }
        }, child);
      }));
    }
