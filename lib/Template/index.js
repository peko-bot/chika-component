...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/component/Template/index.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/component/Template/index.jsx":
/*!******************************************!*\
  !*** ./src/component/Template/index.jsx ***!
  \******************************************/
...
/* harmony import */ var _utils_DeepClone__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/DeepClone */ "./src/utils/DeepClone.js");
...
function (_Component) {
  ...
  function Template() {
    ...
    _this.handleChildEvent = function (childNode, dataItem) {
      if (!childNode || !childNode.props) {
        return childNode;
      }

      var _this$props = _this.props,
          parentOnClick = _this$props.onClick,
          parentOnPress = _this$props.onPress,
          _this$props$timeForTr = _this$props.timeForTriggerLongPress,
          timeForTriggerLongPress = _this$props$timeForTr === void 0 ? 700 : _this$props$timeForTr;
      var childProps = childNode.props;
      var onClick = childProps.onClick,
          onPress = childProps.onPress,
          stopPropagation = childProps.stopPropagation; // todo: find a fixed value for key

      childNode.key = "template-child-".concat(Math.random() * 10000);
      ...
      childProps.onTouchStart = function (e) {
        // if stop bubble, click event on the parent dom will not be called,
        // but if not, callback in core will be called many times
        // TODO: find a way to avoid this dilemma, but now, stop it
        e.stopPropagation();
      ...
      childProps.onTouchMove = function () {
        clearTimeout(timer);
      };

      childProps.onTouchEnd = function () {
        clearTimeout(timer);
    ...
    _this.handleChildData = function (childNode, dataItem) {
      if (!childNode || !childNode.props) {
        return childNode;
      }

      var _this$props2 = _this.props,
          _this$props2$bindKey = _this$props2.bindKey,
          bindKey = _this$props2$bindKey === void 0 ? 'data-key' : _this$props2$bindKey,
          onDataFormat = _this$props2.onDataFormat;
      var childProps = childNode.props;

      if (childProps[bindKey]) {
        var key = childProps[bindKey];
        var value = dataItem[key];
        childProps.children = onDataFormat ? onDataFormat(value, childProps, bindKey) : value;
      }

      return childNode;
    };

    _this.travelChildren = function (children, item) {
      react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.map(children, function (child) {
        var childNode = _this.handleChildEvent(child, item);

        childNode = _this.handleChildData(childNode, item);

        if (child.props && child.props.children && typeof child.props.children !== 'string') {
          _this.travelChildren(child.props.children, item);
        }
      });
    };
    ...
    _this.renderTemplate = function () {
      ...
      var target = template || _this.props.children;
      var children = [];

      for (var i = 0; i < dataSource.length; i++) {
        var item = dataSource[i]; // copy template

        var singleTemplate = Object(_utils_DeepClone__WEBPACK_IMPORTED_MODULE_1__["default"])({}, target); // render it

        _this.travelChildren(singleTemplate, item);
...
/* harmony default export */ __webpack_exports__["default"] = (function (target, options) {
  ...
  var class2type = {
    ...
    return key === undefined || hasOwn.call(obj, key);
      ...
      extend = function extend(target, options) {
